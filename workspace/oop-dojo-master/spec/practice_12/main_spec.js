...
describe("OO入门", function(){
    ...
    it("对象之间的交互-6", function(){
        const class1 = new Class(1);
        const class2 = new Class(2);
        const teacher1 = new Teacher(110,'Tom1',21,[class1,class2]);
        const teacher2 = new Teacher(110,'Tom2',21,[class2]);
        ...
        expect(console.log).toHaveBeenCalledWith( 'I am Tom1. I know Jerry has joined Class 2.');
        expect(console.log).toHaveBeenCalledWith( 'I am Tom2. I know Jerry has joined Class 2.');
